...
sorted by sfpname:user_id/newpage       
          sfpname:trans_code/newlines=2
          sfpname:convert_date/newline=2
          sfpname:convert_time          
...
end of sfpname:convert_date
""/newline
count[sfpname:policy_no]/heading="Total Number Of Policies By Trans Date"
                            
end of sfpname:trans_code
""/newline
